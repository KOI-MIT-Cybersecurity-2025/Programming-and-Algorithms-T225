...
public class Main {
    ...
    private static void displayMainMenu() {
        ...
        System.out.println("4. Update a member's status (Freeze/Activate)"); // This is the new option
        ...
        System.out.println("9. Exit and Save to member_data.csv");
        System.out.println("====================================");
    ...
    private static void processMainMenuChoice(int choice) {
        switch (choice) {
            ...
            case 4:
                handleUpdateStatus();
                break; // Corresponds to the new option
            case 5:
            ...
            case 9:
                ...
                System.out.println("Exiting... Data saved to member_data.csv.");
                break;
            default:
    ...
    /**
     * NEW METHOD: Handles updating a member's status to ACTIVE or FROZEN.
     */
    ...
    // --- Other handler methods from your previous versions ---

    private static void handleLoadFile() {
        System.out.print("Enter filename to load (e.g., member_data.csv): ");
